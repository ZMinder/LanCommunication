...
public class MessageDao {
    ...
    public List<Message> getPrivateMessagesForUser(int userId) {
        String sql = "SELECT * FROM message WHERE receiver_id = ? AND group_id IS NULL ORDER BY timestamp";
        try {
    ...
    public List<Message> getGroupMessages(int groupId) {
        String sql = "SELECT * FROM message WHERE group_id = ? ORDER BY timestamp";
        try {
    ...
    public List<Message> getGroupMessagesFromTimestamp(int groupId, Timestamp timestamp) {
        String sql = "SELECT * FROM message WHERE group_id = ? AND timestamp >= ? ORDER BY timestamp";
        try {
